...
export default function DeliveryPartnerPayments() {
  ...
  // Statistics passed from calculation
        ...
        <div className="bg-white p-4 rounded-lg shadow border border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-sm text-green-600">Processed payouts</p>
            </div>
          </div>
        </div>
        <div className="bg-white p-4 rounded-lg shadow border border-gray-200">
        ...
        <div className="bg-white p-4 rounded-lg shadow border border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-sm text-red-600">Rejected/Failed</p>
            </div>
          </div>
        </div>
        <div className="bg-white p-4 rounded-lg shadow border border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">{deliveryPayments.length}</p>
              <p className="text-sm text-yellow-600">Records found</p>
            </div>
          </div>
        </div>
      </div>
